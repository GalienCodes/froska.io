...
const Claim = () => {
    return (
        <div id='Airdrop' className='max-w-5xl mx-6 md:mx-auto bg-[#F3F4F5] rounded-md text-gray-50  my-10 py-10 px-0  md:px-16 '>
                ...
                <div className='flex flex-col sm:flex-row justify-between items-center'>
                    <div className='text-[#1F1E1E] w-full md:w-1/2'>
                        ...
                        <p className='font-GilroyRegular text-xs w-full md:w-11/12 pt-4 md:pt-2'>
                            As a token of appreciation, you've been awarded <span className='font-GilroyBold '>7000 Froska tokens</span>. 
                        ...
                        <div className='mt-4 text-center sm:text-left w-full sm:w-2/5'>

                        <button className='flex cursor-pointer bg-[#242529] px-3 py-2 rounded-md text-[#FFFFFF]  items-center'>
