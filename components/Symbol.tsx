            ...
            <div className='mx-6 md:mx-6 xl:mx-0'>
                <div className='flex flex-col sm:flex-row justify-between items-center'>
                    <div className='text-[#1F1E1E] w-full md:w-1/2'>
                        ...
                        <p className='font-GilroyRegular text-xs w-11/12 pt-6 md:pt-2'>FROSKA embodies our values—watchfulness, loyalty, and promise. Raised in an environment of care, FROSKA signifies
