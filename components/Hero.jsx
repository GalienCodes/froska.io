        ...
        <div className="mx-4 sm:mx-6 xl:mx-0">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left  ">
            <div className="flex flex-col justify-center sm:justify-start  w-full md:w-2/4 text-center md:text-left">
              ...
              <p className="text-center md:text-left text-[12.5px] dark:text-[#FFFFFF] text-[#717580] font-GilroyRegular py-6">
                Our beloved watchful companion, the endearing feline companion
                of Metis CEO Elena entered our world as a serendipitous
                encounter. Elena, captivated by this furry marvel, embraced
                FROSKA into the Metis family.
              </p>
              <div className="flex justify-center md:justify-start gap-6">
                <Link
                  href="https://app.hercules.exchange/pools/0x70F8Bc8120A5b88Ab59791edc693aF123808120f"
                  target="_blank"
                >
            ...
            <div className="w-2/2 order-first md:order-last mb-12 md:mb-0">
              <Image
                src={darkMode ? heroWhite : heroDark}
                alt="froska"
                className=" w-[280px] h-[310px] text-center"
              />
            </div>
          </div>
        </div>
