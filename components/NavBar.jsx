      ...
      <div className="mx-auto max-w-5xl py-5 bg- w-full z-[1]">
        <div className="flex justify-between items-center">
            ...
            <ul className="flex justify-between items-center gap-4 lg:gap-10 ">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="md:hidden block">
                  <IoMenu
                    className="text-3xl dark:text-[#FFFFFF] text-[#1F1E1E]"
          ...
          <div
            className={
              opened
                ? "block fixed top-0 right-0 bottom-0  shadow-xl  w-5/6 max-w-sm overflow-hidden bg-[#F3F4F5] dark:bg-[#1F1E1E] overflow-y-auto transition-transform duration-300"
                : "hidden"
            }
          >
            {opened ? (
              <div className="flex items-center py-[17px] px-5 justify-between border-b-[1.5px] border-[#eaebec] dark:border-[#42454C]">
                <div className="md:hidden  block">
                  <MdClose
                    className="text-4xl dark:text-[#FFFFFF] text-[#1F1E1E]"
                    onClick={() => handleOpened()}
                  />
                </div>
                <Link
                  href="https://hermes.maiadao.io/#/add/METIS/0x920912668fE3B30F2f286E913a5F3c974e002aEB/false"
                  target="_blank"
                >
